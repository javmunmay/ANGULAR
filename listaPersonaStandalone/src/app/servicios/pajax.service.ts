...
export class PAjaxService {
  private url: string = "http://localhost/curso/ANGULAR/ANGULAR%20GitHub/ANGULAR/listaPersonaStandalone/BACKENDS/servidor.php";

  //Casa: http://localhost/CLASE/ANGULAR/listaPersonas/servidor.php
  //Clase: http://localhost/curso/ANGULAR/ANGULAR%20GitHub/ANGULAR/listaPersonaStandalone/BACKENDS/servidor.php
